...
extern int * bst_to_array(BST * t); //DONE!!!!!!!

extern int bst_get_ith(BST * t, int i); //DONE!!!!!!!

extern int bst_get_nearest(BST * t, int x); //DONE!!!!!

extern int bst_num_geq(BST * t, int x); //DONE!!!!!!!

extern int bst_num_leq(BST * t, int x);//DONE!!!!!

extern int bst_num_range(BST * t, int min, int max); //DONE!!!!!
